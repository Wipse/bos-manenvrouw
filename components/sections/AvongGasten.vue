<template>
  <section
    id="avond-gasten"
    class="bg-primary-50 w-screen h-fit md:py-0 py-16 md:h-screen flex items-center justify-center relative"
  >
    <div class="container mx-auto h-full relative z-10 px-4">
